...
export const ToastProgress: VoidComponent = () => {
  return (
    <ToastPrimitive.ProgressTrack class="h-1 w-full overflow-hidden rounded-xl bg-primary/0 group-[.destructive]:bg-background/20">
      <ToastPrimitive.ProgressFill class="h-full w-(--kb-toast-progress-fill-width) bg-primary ease-linear group-[.destructive]:bg-destructive-foreground" />
