<script lang="ts">
  ...
  async function getDir(){
    ...
    const files = await readDir(selected as string)
    console.log(files);
  }
...
<div>
  <div class="w-1/2 h-full fixed bg-white dark:bg-gray-600 pt-8 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-r-3xl sm:px-5 left-0">
    <div class="h-2 fixed justify-start">
